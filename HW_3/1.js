...
const degreesCel = Number.parseFloat(prompt("Input temperature in degrees Celsius: "));
const degreesFah = (9 / 5) * degreesCel + 32;
const result = degreesFah.toFixed(2);
alert(`The temperature in degrees Fahrenheit is: ${result}`);